...
export class AuthController {
    ...
    @ApiOperation({
        ...
        description: 'Authenticate as either a candidate or employee using email and password. Returns a JWT token and sets it as an HTTP-only cookie.',
    })
    @ApiResponse({
        status: 200,
        description: 'Login successful. Returns access token, user type, and user details. Also sets authentication cookie.',
    })
