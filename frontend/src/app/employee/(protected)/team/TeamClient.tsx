...
interface TeamClientProps {
    initialManager: TeamMember | null;
    initialTeamMembers: TeamMember[];
}

export default function TeamClient({ initialManager, initialTeamMembers }: TeamClientProps) {
    const router = useRouter();
    const theme = useTheme();
    // Use props for initial state
    const [teamMembers] = React.useState<TeamMember[]>(initialTeamMembers);
    const [manager] = React.useState<TeamMember | null>(initialManager);
