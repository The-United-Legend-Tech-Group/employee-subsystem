...
describe('OrganizationStructureController (unit)', () => {
        ...
        children: [
          {
            ...
            title: 'Staff',
            children: [],
            employees: [{ employeeNumber: 'EMP-002', firstName: 'John' }],
          },
        ],
  ...
  it('approveRequest calls service with id and comment', async () => {
    ...
    const result = await controller.approveRequest('abc123', {
  ...
  it('rejectRequest calls service with id and comment', async () => {
    ...
    const result = await controller.rejectRequest('def456', {
        ...
        children: [
          {
            id: '2',
            title: 'Manager',
            children: [{ id: '3', title: 'Staff', children: [] }],
          },
        ],
      },
    ];
