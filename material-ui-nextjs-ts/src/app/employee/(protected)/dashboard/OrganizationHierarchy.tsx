            ...
            sx={{
              ...
              bgcolor:
                node.description === "Open"
                  ? "success.lighter"
                  : "action.hover", // Note: 'success.lighter' might not exist, safer to use alpha or light
              color:
                node.description === "Open" ? "success.dark" : "text.secondary",
              ...(node.description === "Open" && {
    ...
    const fetchHierarchy = async () => {
      try {
        ...
        const response = await fetch(
          `${apiUrl}/organization-structure/hierarchy`,
          {
            headers: {
    ...
    <Card
      ...
      sx={(theme) => ({
        ...
        ...theme.applyStyles("light", {
          backgroundImage:
            "linear-gradient(to top right, rgba(255,255,255,0.8), rgba(255,255,255,0.5))",
