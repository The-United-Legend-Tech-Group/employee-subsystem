        ...
        <AppTheme {...props} themeComponents={xThemeComponents}>
            ...
            <Box sx={{ display: 'flex' }}>
                <SideMenu user={candidate ? {
                    ...
                    image: candidate.profilePictureUrl || '/static/images/avatar/7.jpg'
                } : undefined} />
                <AppNavbar />
                {/* Main content */}
                <Box
                                        ...
                                        <Card variant="outlined" sx={{ mb: 2 }}>
                                            <CardContent>
                                                <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} alignItems="flex-start">
                                                    <Avatar
                                                        src={candidate.profilePictureUrl || '/static/images/avatar/7.jpg'}
                                                    ...
                                                    <Box sx={{ width: '100%', flex: 1 }}>
                                                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                                                            ...
                                                            <Chip label="Candidate" color="primary" size="small" variant="outlined" />
                                                        </Box>
